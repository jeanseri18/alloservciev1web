...
<nav class="navbar navbar-expand-lg">
    <div class="container px-0">
        <a class="navbar-brand" href="{{ route('welcome') }}"><img src="{{ asset('assets/_ALLO-SERVICES-LOGO-BLANC 1.png') }}" alt="Geeks" width="100"/></a>
        <div class="ms-auto d-flex align-items-center order-lg-3">
            <div class="d-flex gap-2 align-items-center">
            <a href="{{ route('register') }}" class="btn btn-dark d-none d-md-block">Commencer</a>

                <a href="{{ route('login') }}" class="btn btn-dark d-none d-md-block">Se connecter</a>
