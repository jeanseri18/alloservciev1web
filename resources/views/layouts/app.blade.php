...
<body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
    <div class="app-wrapper">
                    ...
                    <li class="nav-item dropdown user-menu">
                        ...
                        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                            ...
                            <li class="user-footer">
                                ...
                                <a href="{{ url('/logout') }}" class="btn btn-default btn-flat float-end">Deconnexion</a>
                            </li>
                        </ul>
                    </li>
                </ul>
        ...
        <!-- Sidebar -->
        <aside class="app-sidebar  shadow" data-bs-theme="dark" style="background:linear-gradient(to left top, #0470B8, #023252)">
            <div class="sidebar-brand">
                <a href="{{ url('/') }}" class="brand-link">
                    <img src="{{ asset('assets/_ALLO-SERVICES-LOGO-BLANC 1.png') }}" alt="AdminLTE Logo" class="brand-image opacity-75 shadow">
