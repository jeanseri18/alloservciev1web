...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-9">
            <h3 class="mb-4">Liste des categories</h3>
</div>
                <div class="col-md-3">

                    <a href="{{ route('categories.create') }}" class="btn btn-primary mb-3">ajouter une categorie</a>
</div>
</div><hr>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <img src="{{ asset('storage/' . $category->image) }}"
                                                    alt="Category Image" class="img-thumbnail" style="width: 100px;">
                                                @else
                                                No Image
                                                @endif
                                            </td>
